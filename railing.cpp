...
int main(){
			...
			while(fread(&usr,sizeof(struct user),1,fp)){
				if(!strcmp(usr.username,username)){
					if(!strcmp(usr.password,pword)){
						...
						fflush(stdin);
						scanf("%d",&d.quan);
						printf("Enter your transaction iteration:(1,2,3,...) ");
						scanf("%d",d.tran);
					...
					case 2:
							...
							if(fnw==NULL)
							printf("You must buy first refresh then only can view it in your profile.");
					...
					case 3:
						...
						fp1=fopen(copy,"a+");
						if(fnw==NULL)
						printf("You must buy first then refresh then only you can sell.");
						printf("Enter the transaction iteration of the crypto you want to sell:");
						scanf("%d",&ite);
						...
						printf("You do not have the transction of %d itiration.",ite);
						fclose(fnw);
						fclose(fp1);
					}}
	...
	char password2[50];
			...
			printf("Your Account Has Been Created.\nYou have got 20000 dollars  for signing up.\nPlease LogIn to continue.\n\n\n");
			LogIn();
		}
